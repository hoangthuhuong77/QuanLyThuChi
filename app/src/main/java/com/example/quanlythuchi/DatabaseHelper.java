...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void themGiaoDich(String ghiChu,
                             int soTien,
                             String loai,
                             String danhMuc,
                             String ngay) {
    ...
    public ArrayList<String> layTatCaGiaoDich() {
        ...
        if (cursor.moveToFirst()) {
            ...
            do {
                ...
                String ghiChu =
                        cursor.getString(
                                cursor.getColumnIndexOrThrow("ghiChu"));

                int soTien =
                        cursor.getInt(
                                cursor.getColumnIndexOrThrow("soTien"));

                String loai =
                        cursor.getString(
                                cursor.getColumnIndexOrThrow("loai"));

                String danhMuc =
                        cursor.getString(
                                cursor.getColumnIndexOrThrow("danhMuc"));

                String ngay =
                        cursor.getString(
                                cursor.getColumnIndexOrThrow("ngay"));
    ...
    public ArrayList<Integer> layTatCaId() {
        ...
        Cursor cursor =
                db.rawQuery(
                        "SELECT id FROM GiaoDich ORDER BY id DESC",
                        null
                );
    ...
    public int tinhTongThu() {
        ...
        Cursor cursor = db.rawQuery(
                "SELECT SUM(soTien) FROM GiaoDich WHERE loai='Thu nhập'",
                null
        );
    ...
    public int tinhTongChi() {
        ...
        Cursor cursor = db.rawQuery(
                "SELECT SUM(soTien) FROM GiaoDich WHERE loai='Chi tiêu'",
                null
        );
